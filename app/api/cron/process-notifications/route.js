...
function generateEmailHtml(booking, groupBookings, finalGuide, finalVehicle, isGrouped) {
  ...
  const brandName = bookingRegion === 'shahrisabz' ? 'Shahrisabz CrafTour' : bookingRegion === 'xorazm' ? 'Xorazm CrafTour' : bookingRegion === 'buxoro' ? 'Buxoro CrafTour' : 'Samarqand CrafTour';
  const brandNameCaps = bookingRegion === 'shahrisabz' ? 'SHAHRISABZ CRAFTOUR' : bookingRegion === 'xorazm' ? 'XORAZM CRAFTOUR' : bookingRegion === 'buxoro' ? 'BUXORO CRAFTOUR' : 'SAMARQAND CRAFTOUR';
